	...
	<div class="row justify-content-center">
		<div class="col-md-8">
			<div class="card">
				...
				<div class="card-body">
	<form:form method="POST" class="form-horizontal" action="employee" modelAttribute="employee">
		<form:errors path="*" cssClass="errorblock" element="div" />
		<div class="form-group">
							<form:label path="name" for="name" class="cols-sm-2 control-label">Employee
								Name </form:label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span> <form:input type="text"
										class="form-control" name="name" id="name" path="name"
						...
						<div class="form-group">
							<form:label path="department" for="department" class="cols-sm-2 control-label">Employee
								Department </form:label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span> <form:input type="text"
										class="form-control" name="department" id="department" path="department"
										placeholder="Enter your department" /><form:errors path="department"
						cssClass="error" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<form:label path="designation" for="designation" class="cols-sm-2 control-label">Employee
								Designation </form:label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span> <form:input type="text"
										class="form-control" name="designation" id="designation" path="designation"
										placeholder="Enter your designation" /><form:errors path="designation"
						cssClass="error" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<form:label path="contractor" for="contractor" class="cols-sm-2 control-label">Employee
								Contractor </form:label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span> <form:checkbox 
										class="form-control" name="contractor" id="contractor" path="contractor"
										 /><form:errors path="contractor"
						cssClass="error" />
								</div>
							</div>
						</div>
						<div class="form-group">
							<form:label path="skills" for="skills" class="cols-sm-2 control-label">Employee
								Skills </form:label>
							<div class="cols-sm-10">
								<div class="input-group">
									<span class="input-group-addon"><i class="fa fa-user fa"
										aria-hidden="true"></i></span><form:checkboxes path="skills" items="${skillList}"
										class="form-control" name="skills" id="skill" /><form:errors path="skills"
						cssClass="error" />
								</div>
							</div>
						</div>
