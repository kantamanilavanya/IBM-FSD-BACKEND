	...
	<form action="./delete">
		<table align="center">
			...
			<tr>
				...
				<td><a href="updateEmployee.jsp?name=<%=empDetails.getEmployeeName()%>&id=<%=empDetails.getEmployeeId()%>&gender=<%=empDetails.getGender()%>&department=<%=empDetails.getDepartment()%>&designation=<%=empDetails.getDesignation()%>&salary=<%=empDetails.getSalary()%>&age=<%=empDetails.getEmployeeAge()%>">update</a></td>
